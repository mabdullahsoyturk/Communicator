...
public class DeleteBuyMeTask extends AsyncTask<String, Void, String> {
    ...
    public DeleteBuyMeTask(Context mContext, String facebook_id, String house_id, String buy_me_id, AsyncTaskFinishedObserver observer) {
        this.observer = observer;
        this.mContext = mContext;
        this.facebook_id = facebook_id;
        this.house_id = house_id;
        this.buy_me_id = buy_me_id;
    }
